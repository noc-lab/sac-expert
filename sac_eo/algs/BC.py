...
class BC(MBRLOnPolicyAlg):
    ...
    def __init__(self,idx,env,env_eval,env_expert,actor,expert,init_expert_rms_stats,
        ...
        super(BC,self).__init__(idx,env,env_eval,actor,v_critic,models,
    ...
    def _setup(self,alg_kwargs):
        ...
        super(BC,self)._setup(alg_kwargs)
    ...
    def _expert_preprocess(self):
        ...
        #YOU HAVE TO CREATE A FUNCTION IN MODEL FREE ALGORITHMS NAMED AS
        #update_with_expert!!!!!
        #print("can")
    ...
    def _update(self,num_timesteps,expert_reg):
        ...
        self._update_actor(expert_reg)
        

    def _update_actor(self,expert_reg):
        ...
        if len(self.models) == 1:
            ...
            grads_policy = tape.gradient(MSE_loss,self.actor.trainable)
        else:
