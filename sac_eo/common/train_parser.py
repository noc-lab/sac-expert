#Once you finish developing check the following variables
#epsilon
#expert_path
#expert_file
#expert_buffer_size
#env_batch_size_init it was 5000 before!
#env_horizon it was 1000 before!
#num_mf_updates it was 25 before!
#num_models it was 1 before!
#sim_batch_size it was 10000 before!
#expert_buffer_size new parameter!
#mf_algo
#expert_file was dmc_cheetah_run_mfrl_trpo_sim5e6_050422_001107
#init_from_expert new parameter to experiment with max_exp_state_ratio
#use_expert_actions is a parameter to test the performance.
#be careful with actor_squash
#update_normalizers and only_model_normalizer are new parameters
#scale_max_disc is a new parameter
#


#env_batch_size_init is 50 during code developing!
#env_horizon is 10 during code developing!
#num_mf_updates is 1 during code developing!
#num_models is 1 during code developing!
#sim_batch_size is 100 during code developing!
#expert_buffer_size is 20 
#expert_file is gym_pendulum_mfrl_ppo_122322_160837
#actor_squash is false !!!!
...
# # Adversarial model update parameters
# #########################################
...
# ami_shared_kwargs = [
#     'epsilon_drme','Vsp_gae','Vsp_center','Vsp_scale','ami_start','ami_lr',
#     'ami_update_it','ami_nminibatch','max_perturbed_grad_norm','outer_lr'
# ]

# parser.add_argument('--epsilon_drme',help='DRME epsilon robustness parameter',
#     type=float,default=0.05)

# parser.add_argument('--Vsp_gae',help='use GAE next state values',
#     action='store_true')
# parser.add_argument('--no_Vsp_center',help='do not center next state values',
#     dest='Vsp_center',default=True,action='store_false')
# parser.add_argument('--no_Vsp_scale',help='do not scale next state values',
#     dest='Vsp_scale',default=True,action='store_false')

# parser.add_argument('--ami_start',help='starting policy for ratios',
#     type=str,default='base',choices=['base','last'])

# parser.add_argument('--ami_lr',help='DRME inner learning rate',
#     type=float,default=1e-5)
# parser.add_argument('--ami_update_it',
#     help='number of epochs per AMI update',type=int,default=10)
# parser.add_argument('--ami_nminibatch',
#     help='number of minibatches per epoch in AMI update',type=int,default=32)
# parser.add_argument('--max_perturbed_grad_norm',
#     help='max gradient norm for perturbed model updates',type=float,default=0.5)

# parser.add_argument('--outer_lr',help='DRME outer learning rate',
#     type=float,default=1e-1)
...
# ami_ppo_kwargs = [
#     'ami_early_stop','ami_adaptlr','ami_adapt_factor','ami_adapt_minthresh',
#     'ami_adapt_maxthresh'
# ]

# parser.add_argument('--ami_early_stop',help='early stopping based on TV',
#     action='store_true')

# parser.add_argument('--no_ami_adaptlr',help='do not adapt LR based on TV',
#     dest='ami_adaptlr',default=True,action='store_false')
# parser.add_argument('--ami_adapt_factor',help='factor used to adapt LR',
#     type=float,default=0.03)
# parser.add_argument('--ami_adapt_minthresh',
#     help='min multiple of TV for adapting LR',type=float,default=0.0)
# parser.add_argument('--ami_adapt_maxthresh',
...
# ami_trpo_kwargs = [
#     'ami_cg_it','ami_trust_sub','ami_trust_damp','ami_kl_maxfactor'
# ]

# parser.add_argument('--ami_cg_it',help='conjugate gradient iterations',
#     type=int,default=20)
# parser.add_argument('--ami_trust_sub',help='trust region subsampling factor',
#     type=int,default=1)
# parser.add_argument('--ami_trust_damp',help='trust region damping coefficient',
#     type=float,default=0.01)
# parser.add_argument('--ami_kl_maxfactor',
#     help='mult factor for backtracking line search',type=float,default=1.5)

# # AMI-KLPen
# # ---------------------------

# ami_klpen_kwargs = [
#     'reset_perturbed','ami_kl_direction','lagrange_init'
# ]

# parser.add_argument('--reset_perturbed',
#     help='reset perturbed models between policy updates',
#     action='store_true')

# parser.add_argument('--ami_kl_direction',help='KL penalty direction',
#     type=str,default='forward',choices=['forward','reverse'])

# parser.add_argument('--lagrange_init',help='DRME lagrange initial value',
#     type=float,default=1.0)

# # Combined
# # ---------------------------
# ami_update_kwargs = ami_shared_kwargs + ami_ppo_kwargs + ami_trpo_kwargs + ami_klpen_kwargs
